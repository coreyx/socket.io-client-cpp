...
# https://sourceforge.net/projects/boost/files/boost/1.60.0/boost_1_60_0.zip/download
$download_url = "http://bit.ly/1RbCdbM"
...
# Modified to build 64-bit (debug & release) and to use the Visual Studio 14.0 compiler
& .\bjam install --prefix=$boost_dir --with-system --with-date_time --with-random link=static runtime-link=shared threading=multi address-model=64 --toolset=msvc-14.0 debug release
